#!/usr/bin/env bash
# Real-PostgreSQL proof for 6C-b9 — de tegenboekingsmotor
# (20260921120000_add_ledger_reversal_posting.sql).
#
...
#     supabase/tests/ledger-reversal/run-proof.sh
#
# It applies, in order:
...
#   20260921120000_...sql   the REAL migration under test, applied TWICE
