  ...
  public: {
    Tables: {
      ...
      clients: {
        ...
        Relationships: [
          {
            foreignKeyName: "clients_bank_rekening_id_fkey"
            columns: ["bank_rekening_id"]
            isOneToOne: false
            referencedRelation: "grootboekrekeningen"
            referencedColumns: ["id"]
          },
      ...
      sales_invoice_postings: {
        ...
        Relationships: [
          {
            foreignKeyName: "sales_invoice_postings_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sales_invoice_postings_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "sales_invoice_postings_sales_invoice_id_fkey"
