...
- **Nog geen UI.** De afsluitknop en de bevestigingsflow zijn PR 2b.

**Wat PR 1 nog openliet (inmiddels beslist in 6C-b10):**
...
- **Er bestaat nog geen afsluitmutatie**, geen doorrol en geen resultaatboeking; `afgesloten_boekjaar` wordt nergens in code gezet. — *Achterhaald door 6C-b10: de afsluitmutatie bestaat nu, en juist zónder doorrol en zónder resultaatboeking. De twee punten hierboven blijven staan als vastgestelde feiten: zij zijn de reden dat v1 geen van beide maakt.*
