...
- **Niet-ondersteunde bronsoorten** (`reversal`, `opening_balance`) krijgen geen knop maar een uitleg, afgelezen uit de opgeslagen `source_type` en nooit uit een rekeningnummer of label.
